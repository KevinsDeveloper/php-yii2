...
class Encrypt extends Component
{
	...
	function get_key($key = '')
	{
		if ($key == '')
		{
			...
			//$CI =& get_instance();
			$key = 'hasdf7348jdfo7kr2p3ujdft34ujt54tu';
			if ($key == FALSE)
			{
				echo 'In order to use the encryption class requires that you set an encryption key in your config file.';
			}
		}
	...
	public function sha1($str)
	{
		if ( ! function_exists('sha1'))
		{
			...
			{
				require_once(BASEPATH.'Sha1.php');
				$SH = new CI_SHA;
